  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        {/* App Header */}
        <header className="sticky top-0 z-50 bg-indigo-600 shadow-sm">
          <div className="mx-auto flex h-10 max-w-6xl items-center justify-between px-4">
            ...
            <div className="flex items-center gap-2">
              <span className="rounded-full bg-white/20 px-2 py-0.5 text-[10px] font-medium text-white tracking-wide uppercase">
                Beta
              </span>
              <Link
                href="/settings"
