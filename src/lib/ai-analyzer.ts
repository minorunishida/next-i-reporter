...
2. 値が入っているだけのセル（ラベル・見出し・タイトル）はスキップする。クラスタにしない
...
1. **ラベル・見出しはスキップ**: テキストが入っているだけのラベルセルはクラスタにしない（PDF背景で表示される）
              ...
              items: {
                ...
                properties: {
                  ...
                  type: {
                    type: "number",
                    description:
                      "クラスタ型の数値 (KeyboardText=30, Date=40, Time=50, InputNumeric=65, Calculate=67, Select=70, Check=90, Image=100, Handwriting=119)",
                  },
